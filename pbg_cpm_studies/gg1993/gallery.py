...
# figure lifted from the PDF. Every pixel below is our own pbg-cpm output.
_PROVENANCE = (
    "GENERATED by pbg-cpm — our own Cellular Potts simulation output. "
...
def sync_study_charts(slug):
    ...
    own pbg-cpm output, never lifted from the PDF.
    """
    figs = _fig_order(slug)
